...
var indexNav = [
    ...
    {
        name: '校友风采',
        url: './pages/xiaoyoufengcai/list.html'
    },
    {
        name: '校友分会',
        url: './pages/xiaoyoufenhui/list.html'
    },
    {
        name: '校友',
...
var adminurl =  "http://localhost:8080/xiaoyouwang/admin/dist/index.html#/login";
