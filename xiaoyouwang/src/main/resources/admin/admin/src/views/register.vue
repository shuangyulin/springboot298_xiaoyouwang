<template>
    <div style="backgroundImage: url('/xiaoyouwang/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">计算机学院校友网注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="校友姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="校友姓名"  />
                        </el-form-item>
