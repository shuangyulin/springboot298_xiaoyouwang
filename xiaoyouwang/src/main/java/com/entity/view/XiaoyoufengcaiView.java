...
public class XiaoyoufengcaiView extends XiaoyoufengcaiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 奖项类型的值
		*/
		private String xiaoyoufengcaiValue;
	...
	public XiaoyoufengcaiView(XiaoyoufengcaiEntity xiaoyoufengcaiEntity) {
		try {
			...
			* 获取： 奖项类型的值
			*/
			public String getXiaoyoufengcaiValue() {
				return xiaoyoufengcaiValue;
			}
			/**
			* 设置： 奖项类型的值
			*/
			public void setXiaoyoufengcaiValue(String xiaoyoufengcaiValue) {
				this.xiaoyoufengcaiValue = xiaoyoufengcaiValue;
			}
